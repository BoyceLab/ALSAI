...
**A practical AI training program for ALS TDI researchers, scientists, and staff.**

Covering everything from how large language models work to hands-on use of Claude and Google Antigravity for literature review, data analysis, grant writing, bioinformatics pipelines, OMOP queries, and clinical note extraction.
